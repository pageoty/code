...
# =============================================================================
    ...
    parcelle=geo.read_file("/run/media/pageot/Transcend/Yann_THESE/BESOIN_EAU//BESOIN_EAU/DONNEES_RAW/DONNEES_MAIS_CLASSIF/Classif_Adour_2017_maïs_all.shp")
...
# mettre cela en df SAMIR    
    ...
    meteo["Irrig"]=0.0
    meteo.to_csv('/run/media/pageot/Transcend/Yann_THESE/BESOIN_EAU/BESOIN_EAU/TRAITEMENT/INPUT_DATA/DATA_METEO_BV/PARCELLE_CLASSIF/meteo_all_mais_'+years+'.csv')
    meteo2=pd.read_csv('/run/media/pageot/Transcend/Yann_THESE/BESOIN_EAU/BESOIN_EAU/TRAITEMENT/INPUT_DATA/DATA_METEO_BV/PARCELLE_CLASSIF/meteo_all_mais_'+years+'.csv')
