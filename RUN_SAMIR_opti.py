...
if __name__ == "__main__":
    ...
    for y in ["2006"]:# "2008","2010","2012","2014","2015","2017","2019"
        print (y)
        name_run="RUNS_optim_LUT_LAM_ETR/Run_opti_param_v2"
        d={}
        ...
        os.system('python /mnt/c/users/Yann\ Pageot/Documents/code/modspa/modspa2/code/models/main/runSAMIR.py -wd /mnt/d/THESE_TMP/RUNS_SAMIR/'+name_run+'/'+str(y)+'/'' -dd /mnt/d/THESE_TMP/RUNS_SAMIR/'+name_run+'/'+str(y)+'/Inputdata/ -m meteo.df -n maize/NDVI.df -fc maize/FC.df -wp maize/WP.df -o output_test -p param_modif.csv  -optim param_SAMIR12_13_optim.csv --cal ET --init 1')
