...
if __name__ == '__main__':
    ...
    plt.legend()
    plt.ylim(0,30)
    plt.xlabel("Valeur de RFU en mm ")
    plt.ylabel("Fréquence ")
...
# =============================================================================
    NDVI_stat_irri=[]
    NDVI_stat_irri_auto=[]
    param=pd.read_csv(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto_v2_irri_date_satr_free/2017/Output/maxZr/output_test_maize_irri_param.txt",header=None,skiprows=1,sep=";")
    IRR=[]
    ids=[]
    ...
    for i in data_prof.ID:
        ...
        UTS=pickle.load(open(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto_v2_irri_date_satr_free/2017/Output/maxZr/output_test_maize_irri_"+str(int(c))+".df","rb"))
    ...
    #           xytext=(-6,2), # distance from text to points (x,y)
    #           ha='center')
    plt.savefig("/run/media/pageot/Transcend/Yann_THESE/BESOIN_EAU/BESOIN_EAU/TRAITEMENT/RUNS_SAMIR/Plot_resu_all_parcelle_partenaires/scatter_maxZrUTS_PF_CC_GSM_with_FCOVER_free_start_irri.png")
