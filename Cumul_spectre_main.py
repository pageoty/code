...
#    plt.plot(df_mean_NDWI.index,df_mean_NDWI[11.0])
    for y in ["2017","2018"]:
        ...
        plt.legend((p1[0],p2[0]),("Maize irrigated ","Sunflower"))
        ...
        plt.ylabel ( "NDVI cumulated")
        plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/PLOT_CUMUL_temporelle/ADOUR_BV_MAIZE_SUNFLOWER"+y+".png")