...
# =============================================================================
    ...
    for r in runs:
        ...
        bias=1/sum_irr_cacg_val.shape[0]*sum(mean(all_resu.loc[all_resu.runs==r]["cumul_irr"])-sum_irr_cacg_val) 
        fitLine = predict(sum_irr_cacg_val)
        plt.figure(figsize=(7,7))
        plt.title(r)
        plt.plot([0.0, 250], [0.0, 250], 'r-', lw=2)
...
#         plot nb_irr
        ...
        plt.text(10,min(all_resu.loc[all_resu.runs==r]["nb_irr"])+0.5,"Pente = "+str(round(slope,2)))
        plt.text(10,min(all_resu.loc[all_resu.runs==r]["nb_irr"])+0,"Biais = "+str(round(bias,2)))
