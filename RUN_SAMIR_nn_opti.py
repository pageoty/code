...
if __name__ == "__main__":
    ...
    for y in ["2006","2008","2010","2012","2014","2015"]: #"2008","2010","2012","2014","2015","2017","2019"
        ...
        params_update(d['SAMIR_run']+"/Inputdata/param_SAMIR12_13.csv",
                      d['SAMIR_run']+"/Inputdata/param_modif.csv",date_start=str(y)+str('0501'),date_end=str(y)+str('1026'),Ze=120,minZr=120,REW=30,maxZr=1500,Zsoil=3000,DiffE=0.00001,DiffR=0.00001,m=0.15,Irrig_auto=0,Irrig_man=1,Lame_max=30,Init_RU=1,KmaxKcb=1.15)
        params_update(d['SAMIR_run']+"/Inputdata/param_modif.csv",
                      d['SAMIR_run']+"/Inputdata/param_modif.csv",date_start=str(y)+str('0501'),date_end=str(y)+str('1026'),ligne_OS=7,Ze=120,REW=-10,minZr=120,maxZr=1500,A_kcb=1.358,Koffset=-0.017,Zsoil=3000,DiffE=10,DiffR=10,Irrig_auto=0,Irrig_man=1,Init_RU=1,KmaxKcb=1.15)
