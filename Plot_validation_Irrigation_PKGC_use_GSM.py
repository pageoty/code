...
if __name__ == '__main__':
    d={}
    name_run="RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto/"
    name_run_save_fig="RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto/"
    ...
    param=pd.read_csv(d["PC_disk"]+"//TRAITEMENT/RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto/2017/Output/maxZr/output_test_maize_irri_param.txt",header=None,skiprows=1,sep=";")
    IRR=[]
    yerrmore=[]
    yerrless=[]
    for i in data_prof.ID:
        ...
        UTS=pickle.load(open(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto/2017/Output/maxZr/output_test_maize_irri_"+str(int(c))+".df","rb"))
    ...
    tab_f2.to_csv(d["PC_disk"]+"//TRAITEMENT/RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto/tab_resu_PKGC_depth_PF_CC_GSM.csv")
    ...
    plt.savefig(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/Plot_result/plot_scatter_volumes_Irrigation_forcagemaxZr_soil_depth_GSM_PFCC.png")
...
# =============================================================================
    param=pd.read_csv(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto_300_1900/2017/Output/maxZr/output_test_maize_irri_param.txt",header=None,skiprows=1,sep=";")
    IRR=[]
    ids=[]
    data_prof=pd.read_csv(d["PC_disk"]+"/TRAITEMENT/SOIL/GSM/Extract_GSM_parcelle_PKGC_GERS_2017_GSM_PF_CC_class_name.csv",index_col=[0],sep=',',encoding='latin-1',decimal=',')
    for i in data_prof.ID:
        ...
        UTS=pickle.load(open(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/GERS/PKGC_Fcover_GSM_irri_auto_300_1900/2017/Output/maxZr/output_test_maize_irri_"+str(int(c))+".df","rb"))
        data_id=UTS.groupby("id")
        ID_data=data_id.get_group(i)
        IRR.append([i,ID_data.Ir_auto.sum(),val.values[0],ID_data.TAW.max()])
    ...
    #           xytext=(-6,2), # distance from text to points (x,y)
    #           ha='center')
    plt.savefig(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/Plot_result/plot_scatter_Irrigation_forcagemaxZr_RUMvalue_GSM_PF_CC.png")
