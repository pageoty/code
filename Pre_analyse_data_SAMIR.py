...
# =============================================================================
        ...
        #     plt.plot(SWC["Date"],np.repeat(0.363-RU75,len(SWC["Date/Time"])),c="b",linestyle='--',label='RU 75 %')
        #     plt.legend()
        #     plt.ylabel('SWC en profondeur 30 cm')
        #     ax3 = plt.subplot(313)
...
#     Analyse Météo
# ============================================================================
    meteo_SAF=pd.read_csv(d["PC_disk_home"]+"/TRAITEMENT/INPUT_DATA/DATA_METEO_BV/PARCELLE_LAM/meteo_lam_2010.csv",decimal=".")
