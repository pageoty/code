...
# =============================================================================
    ...
    dfGSM=pd.read_csv(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/PKGC_GSM_init_ru_optim_P055_Fcover_fewi_De_Kr_days10_dose30_400_2500_irri_auto_soil/Table_RMSE_parcelle_min.csv",sep=",")
    dfRRP=pd.read_csv(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/PKGC_RRP_init_ru_optim_P055_Fcover_fewi_De_Kr_days10_dose30_400_2500_irri_auto_soil/Table_RMSE_parcelle_min.csv")
    dfUTS=pd.read_csv(d["PC_disk"]+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/PKGC_init_ru_optim_P055_Fcover_fewi_De_Kr_days10_dose30_400_2500_irri_auto_soil/Table_RMSE_parcelle_min.csv")
    ...
    for i in dfUTS.ID:
        ...
        GSM=pickle.load(open(d["PC_disk"]+"TRAITEMENT/RUNS_SAMIR/RUN_PKGC/PKGC_GSM_init_ru_optim_P055_Fcover_fewi_De_Kr_days10_dose30_400_2500_irri_auto_soil/2017/Output/maxZr/output_test_maize_irri_"+str(int(a))+".df","rb"))
        RRP=pickle.load(open(d["PC_disk"]+"TRAITEMENT/RUNS_SAMIR/RUN_PKGC/PKGC_RRP_init_ru_optim_P055_Fcover_fewi_De_Kr_days10_dose30_400_2500_irri_auto_soil/2017/Output/maxZr/output_test_maize_irri_"+str(int(b))+".df","rb"))
        ...
        TAWdfGSM=GSM.loc[GSM.id==i][["date","Dr",'Ir_auto',"TAW","Zr","FCov"]]
        TAWdfRRP=RRP.loc[RRP.id==i][["date","Dr",'Ir_auto',"TAW","Zr"]]
        TAWdfUTS=UTS.loc[UTS.id==i][["date","Dr",'Ir_auto',"TAW","Zr"]]
        ...
        # plt.plot(TAWdfGSM.date,TAWdfGSM.Zr,c='Blue',label="GSM",linestyle=":")
        ...
        # plt.plot(TAWdfGSM.date,TAWdfRRP.Zr,c='r',label="RRP",linestyle=":")
        ...
        # plt.figure(figsize=(7,7))
        # plt.plot(TAWdfGSM.date,TAWdfGSM.FCov*1000,c='black',label="Fcov",linestyle="-")
        # plt.plot(TAWdfGSM.date,TAWdfUTS.Zr,c='g',label="UTS")
        # plt.plot(TAWdfGSM.date,TAWdfGSM.Zr,c='b',label="GSM")
        # plt.plot(TAWdfGSM.date,TAWdfRRP.Zr,c='r',label="RRP")
        # plt.plot(TAWdfGSM.date,TAWdfRRP.Ir_auto*10,c='r',label="RRP",linestyle="",marker='o')
        # plt.plot(TAWdfGSM.date,TAWdfGSM.Ir_auto*10,c='b',label="GSM",linestyle="",marker='o')
        # plt.plot(TAWdfGSM.date,TAWdfUTS.Ir_auto*10,c='g',label="UTS",linestyle="",marker='o')
        # plt.legend()
        # plt.title(i)
    ...
    # plt.savefig(d['PC_disk']+"/TRAITEMENT/RUNS_SAMIR/RUN_PKGC/Plot_result/scatter_MAXZR_type_sol_data.png")
...
# =============================================================================
#     Variation soil forcage p et maxZr à 1000
# =============================================================================
...
# =============================================================================
    ...
    fstp.soil_categories(country="Ainse")
    fstp.scatter_from_csv(d["PC_disk"]+"/TRAITEMENT/SOIL/tex_GSM_ADOUR_TARN_2018.csv",hue='nb', cmap=cm.copper_r, alpha=1,s=50)
    fstp.colorbar('nombre de parcelles')
