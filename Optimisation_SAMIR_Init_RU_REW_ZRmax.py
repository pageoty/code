...
# =============================================================================
        if "CACG" not in name_run and "PKGC" not in name_run:
            y1=int(y)-1
                ...
                if len(classes)==2:
                    ...
                    if 'irri_auto' in name_run:
                        params_update(d['SAMIR_run']+"/Inputdata/param_SAMIR12_13.csv",
                                 ...
                                 Ze=150,REW=8,minZr=150,maxZr='optim',Zsoil=3000,DiffE=0.00001,DiffR=0.00001,Init_RU=1,Irrig_auto=1,Irrig_man=0,Plateau=0,Lame_max=30,m=1,minDays=20,p=0.6,Start_date_Irr=str(y)+str('0501'),A_kcb=float(str(args.akcb).strip("['']")), Koffset=float(str(args.bkcb).strip("['']")))
        ...
        if "LAI" in name_run :
            ...
            elif "CACG" in name_run or "PKGC" in name_run:
                if "Fcover" in name_run:
