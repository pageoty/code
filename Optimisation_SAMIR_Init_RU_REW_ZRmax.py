...
# =============================================================================
        ...
        #  Lecture file PF_CC
            ...
            # PF_CC=pd.read_csv(d["disk"]+"/Yann_THESE/BESOIN_EAU/BESOIN_EAU/TRAITEMENT/SOIL/RRP/Extract_RRP_GERS_parcelle_PKCG_"+str(y)+"_UTS_majs.csv",index_col=[0],sep=';',encoding='latin-1',decimal=',')
            ...
            if optimis_val =="REW" :
                ...
                if len(classes)==2:
                    ...
                    if 'irri_auto' in name_run:
                        ...
                        params_opti(d["SAMIR_run"]+"/Inputdata/param_SAMIR12_13_optim.csv",output_path=d["SAMIR_run"]+"/Inputdata/test_optim.csv",param1="maxZr",value_P1="1000/1050/50/lin")
                    else:
