...
if __name__ == '__main__':
    ...
    RRP_shp=geo.read_file(d["PC_disk"]+"DONNEES_RAW/DONNES_SOIL/RRP_Midi_pyrénées/RRP"+drpt+"/Cartographie_RRP"+drpt+"/RRP_"+drpt+"_VF.shp")
    ...
    tab_UCS=pd.read_csv(d["PC_disk"]+"DONNEES_RAW/DONNES_SOIL/RRP_Midi_pyrénées/RRP"+drpt+"/BDDonesol_RRP"+drpt+"/"+name31+"_table_ucs.csv",sep=";",encoding="latin-1")
    id_UCS=tab_UCS.loc[tab_UCS.no_ucs==float(No_ucs)]["id_ucs"]
    # Lecture file Table UTS
    tab_UTS=pd.read_csv(d["PC_disk"]+"DONNEES_RAW/DONNES_SOIL/RRP_Midi_pyrénées/RRP"+drpt+"/BDDonesol_RRP"+drpt+"/"+name31+"_table_l_ucs_uts.csv",sep=";")
    UTS=tab_UTS.loc[tab_UTS.id_ucs==int(id_UCS)]
    UTS_maj=UTS.loc[UTS.pourcent==UTS.pourcent.max()]["id_uts"]
    tab_UTS_prof=pd.read_csv(d["PC_disk"]+"DONNEES_RAW/DONNES_SOIL/RRP_Midi_pyrénées/RRP"+drpt+"/BDDonesol_RRP"+drpt+"/"+name31+"_table_uts.csv",sep=";",encoding="latin-1")
    ...
    tab_strat=pd.read_csv(d["PC_disk"]+"DONNEES_RAW/DONNES_SOIL/RRP_Midi_pyrénées/RRP"+drpt+"/BDDonesol_RRP"+drpt+"/"+name31+"_table_strate.csv",sep=";",encoding="latin-1")
    ...
    tab_strat_quat=pd.read_csv(d["PC_disk"]+"DONNEES_RAW/DONNES_SOIL/RRP_Midi_pyrénées/RRP"+drpt+"/BDDonesol_RRP"+drpt+"/"+name31+"_table_strate_quant.csv",sep=";",encoding="latin-1")
