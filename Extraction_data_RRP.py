...
if __name__ == '__main__':
    ...
    # parcelle=geo.read_file(d["PC_labo_disk"]+"/DONNEES_RAW/PARCELLE_LABO/PARCELLE_LABO_LAM_L93.shp")
    parcelle=geo.read_file(d["PC_labo_disk"]+"/TRAITEMENT/RUNS_SAMIR/DATA_Validation/Parcelle_2017.shp")
